...
{
    [DataContract()]
    public partial class gethospsoplist_spResultDto
    {
        [DataMember()]
        ...
        [DataMember()]
        public Nullable<DateTime> d_FechaHoraCirugia { get; set; }

        [DataMember()]
        public Nullable<DateTime> d_FechaHoraHospPac { get; set; }
        ...
        public gethospsoplist_spResultDto()
        {
        }

        public gethospsoplist_spResultDto(String tipoDeIngreso, String tipoProcedimiento, Nullable<DateTime> d_FechaIngreso, Nullable<DateTime> d_FechaHoraCirugia, Nullable<DateTime> d_FechaHoraHospPac, Nullable<DateTime> d_FechaAlta, String v_Paciente, String tipoDocumento, String v_DocNumber, Nullable<Int32> historiaClinica, Nullable<Int32> edad, String v_Cie10, String v_Diagnostico, String v_MedicoTratante, String especialidad, Nullable<Decimal> monto, Decimal d_PagoMedico, String medicoPago, Decimal d_PagoPaciente, String pacientePago, String v_CIE10IdSalida, String v_DiseasesNameSalida, Nullable<Int32> i_ProcedimientoSOP, String v_ProcedimientoSOP, String v_Servicio, String v_NroLiquidacion, String vendedorExterno, String v_Comentariox, String v_HopitalizacionId, String v_PersonId, Nullable<Int32> i_IsDeleted, String value1, String value2)
        {
			this.TipoDeIngreso = tipoDeIngreso;
			this.TipoProcedimiento = tipoProcedimiento;
			this.d_FechaIngreso = d_FechaIngreso;
			this.d_FechaHoraCirugia = d_FechaHoraCirugia;
			this.d_FechaHoraHospPac = d_FechaHoraHospPac;
