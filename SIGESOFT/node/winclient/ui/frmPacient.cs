    ...
    public partial class frmPacient : Form
    {
        ...
        private void btnAnexoHistoriaManual_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Person = grdData.Selected.Rows[0].Cells["v_FirstLastName"].Value.ToString() + " " + grdData.Selected.Rows[0].Cells["v_SecondLastName"].Value.ToString()
                                + " " + grdData.Selected.Rows[0].Cells["v_FirstName"].Value.ToString();
