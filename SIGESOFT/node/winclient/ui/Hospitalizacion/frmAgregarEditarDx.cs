...
{
    public partial class frmAgregarEditarDx : Form
    {
        ...
        public frmAgregarEditarDx(string _HospiId, string _DxT)
        {
            HospiId = _HospiId;
            DxT = _DxT;
            InitializeComponent();
        ...
        private void frmAgregarEditarDx_Load(object sender, EventArgs e)
        {
            ...
            if (DxT == "DxE")
            {
                if (!string.IsNullOrEmpty(_HospiDto.v_DxIngreso))
                {
                    cbDx.Text = _HospiDto.v_DxIngreso;
                    txtCie10.Text = _HospiDto.v_CIEIdIngreso;
                }
            }
            else
            {
                if (!string.IsNullOrEmpty(_HospiDto.v_DxSalida))
                {
                    cbDx.Text = _HospiDto.v_DxSalida;
                    txtCie10.Text = _HospiDto.v_CIEIdSalida;
                }
            }
        }
        ...
        private void btnGuardarTicket_Click(object sender, EventArgs e)
        {
            ...
            if (DxT == "DxE")
            {
                _hospitalizacionDto.v_DxIngreso = cbDx.Text;
                _hospitalizacionDto.v_CIEIdIngreso = txtCie10.Text;
            }
            else
            {
                _hospitalizacionDto.v_DxSalida = cbDx.Text;
                _hospitalizacionDto.v_CIEIdSalida = txtCie10.Text;
            }
