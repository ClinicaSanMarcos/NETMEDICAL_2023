...
{
    public partial class frmEditatarHorasSOP : Form
    {
        ...
        public frmEditatarHorasSOP(string _HospiId)
        {
            HospiId = _HospiId;
            InitializeComponent();
        }

        private void frmEditatarHorasSOP_Load(object sender, EventArgs e)
        {
