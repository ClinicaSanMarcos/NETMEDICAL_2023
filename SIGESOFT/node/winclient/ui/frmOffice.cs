    ...
    public partial class frmOffice : Form
    {
        ...
        private void Llamar()
        {
          ...
          //}
            ...
            btnLlamar.Enabled = false;
            /*
             * Atender directo al paciente WA
             */
        ...
        private void grdListaLlamando_InitializeRow(object sender, Infragistics.Win.UltraWinGrid.InitializeRowEventArgs e)
        {
            ...
            if (atendido != null)
            {
                ...
                e.Row.Cells["b_NoLlamar"].Value = "ATENDIDO";
            ...
            else
            {
                ...
                e.Row.Cells["b_NoLlamar"].Value = "PENDIENTE";
        ...
        private void btnRefresh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    objCalendarList = objCalendarBL.GetPacientInLineByComponentId1(ref objOperationResult, 0, null, "HorarioAtencion ASC", _componentId, DateTime.Now.Date, _componentIds.ToArray(), int.Parse(cbService.SelectedValue.ToString()));
                }
                else
                {
                  var client = Globals.ClientSession.GetAsList();
                  objCalendarList = objCalendarBL.GetPacientInLineByComponentId1_ATX(ref objOperationResult, 0, null, "HorarioAtencion ASC", _componentId, DateTime.Now.Date, _componentIds.ToArray(), int.Parse(cbService.SelectedValue.ToString()), Int32.Parse(client[2]));
                }
        ...
        private void AfterSelectChangeEventArgs()
        {
