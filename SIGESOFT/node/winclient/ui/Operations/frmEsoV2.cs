...
namespace Sigesoft.Node.WinClient.UI.Operations
{
    public partial class FrmEsoV2 : Form
    {
        ...
        {
            var exams = _serviceBL.GetServiceComponentsReport(servicio);
            ...
            {
                peso =
                    antro.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_PESO_ID) == null
                        ? ""
                        : antro.ServiceComponentFields
                            .Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_PESO_ID).v_Value1;
                peso_unidad =
                    antro.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_PESO_ID) == null
                        ? ""
                        : antro.ServiceComponentFields
                            .Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_PESO_ID)
                ...
                talla =
                    antro.ServiceComponentFields.Find(p =>
                        ...
                        ? ""
                        : antro.ServiceComponentFields
                            .Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_TALLA_ID).v_Value1;
                talla_unidad =
                    antro.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_TALLA_ID) == null
                        ? ""
                        : antro.ServiceComponentFields
                            .Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_TALLA_ID)
                            .v_MeasurementUnitName;
                imc = antro.ServiceComponentFields.Find(p =>
                          p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_IMC_ID) == null
                    ? ""
                    : antro.ServiceComponentFields
                        .Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_IMC_ID).v_Value1;
                imc_unidad =
                    antro.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_IMC_ID) == null
                        ? ""
                        : antro.ServiceComponentFields
                            .Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_IMC_ID)
                            .v_MeasurementUnitName;
            }
            ...
            if (funcVit != null)
            {
                temp = funcVit.ServiceComponentFields.Find(p =>
                           p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_TEMPERATURA_ID) == null
                    ? ""
                    : funcVit.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_TEMPERATURA_ID).v_Value1;
                temp_unidad =
                    funcVit.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_TEMPERATURA_ID) == null
                        ? ""
                        : funcVit.ServiceComponentFields
                            .Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_TEMPERATURA_ID)
                            .v_MeasurementUnitName;
                pres_Sist =
                    funcVit.ServiceComponentFields.Find(p =>
                        ...
                        ? ""
                        : funcVit.ServiceComponentFields
                            .Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_PAS_ID).v_Value1;
                pres_Diast =
                    funcVit.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_PAD_ID) == null
                        ? ""
                        : funcVit.ServiceComponentFields
                            .Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_PAD_ID).v_Value1;
                pres_Diast_unidad =
                    funcVit.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_PAD_ID) == null
                        ? ""
                        : funcVit.ServiceComponentFields
                            .Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_PAD_ID)
                            .v_MeasurementUnitName;
                frecCard =
                    funcVit.ServiceComponentFields.Find(p =>
                        ...
                        ? ""
                        : funcVit.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_FREC_CARDIACA_ID).v_Value1;
                frecCard_unidad =
                    funcVit.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_FREC_CARDIACA_ID) == null
                        ? ""
                        : funcVit.ServiceComponentFields
                            .Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_FREC_CARDIACA_ID)
                            .v_MeasurementUnitName;
                frecResp =
                    funcVit.ServiceComponentFields.Find(p =>
                        ...
                        ? ""
                        : funcVit.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_FREC_RESPIRATORIA_ID).v_Value1;
                frecResp_unidad =
                    funcVit.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_FREC_RESPIRATORIA_ID) == null
                        ? ""
                ...
                spo2_unidad =
                    funcVit.ServiceComponentFields.Find(p =>
                        ...
                        ? ""
                        : funcVit.ServiceComponentFields
                            .Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_SAT_O2_ID)
                            .v_MeasurementUnitName;
            }
        ...
        private void LoadDatosPaciente()
        {
            ...
            string TipoDocumento = datos.TipoDocumento == 1
                ? "D.N.I."
                : datos.TipoDocumento == 2
                    ? "PASAPORTE"
                    : datos.TipoDocumento == 3
                        ? "OTROS DOCUMENTOS"
                        : "CARNET DE EXTRANJERÍA";
            string GradoInstruccion = datos.GradoInstruccion == 1 ? "- - -" :
                datos.GradoInstruccion == 2 ? "PRIMARIA INCOMPLETA" :
                datos.GradoInstruccion == 3 ? "PRIMARIA COMPLETA" :
                datos.GradoInstruccion == 4 ? "SECUNDARIA INCOMPLETA" :
                datos.GradoInstruccion == 5 ? "SECUNDARIA COMPLETA" :
                datos.GradoInstruccion == 6 ? "TÉCNICO" :
                datos.GradoInstruccion == 7 ? "UNIVERSITARIO" :
                datos.GradoInstruccion == 8 ? "TÉCNICO INCOMPLETO" :
                datos.GradoInstruccion == 9 ? "UNIVERSITARIO INCOMPLETO" :
                datos.GradoInstruccion == 10 ? "POST-GRADO" : "DOCTORADO";
            string EstadoCivil = datos.EstadoCivil == 1 ? "SOLTERO(A)" :
                datos.EstadoCivil == 2 ? "CASADO(A)" :
                datos.EstadoCivil == 3 ? "VIUDO(A)" :
                datos.EstadoCivil == 4 ? "DIVORCIADO(A)" : "CONVIVIENTE";
            txtEmployee.Text = datos.Trabajador;
            DocType.Text = TipoDocumento;
            txtNumDocument.Text = datos.NroDocumento;
            GInstruccion.Text = GradoInstruccion;
            EstCivil.Text = EstadoCivil;
            textNacionalidad.Text = datos.Nacionalidad;
            txtAge.Text=Common.Utils.GetAge(datos.FechaNacimiento.Value).ToString();
            txtFNac.Text = datos.FechaNacimiento.ToString();
            textHijos.Text = datos.NroHijos.ToString();
        ...
        private void SumaryWorker(ServiceData dataService)
        {
            ...
            lblPersonId.Text = dataService.PersonId;
            lblTrabajador.Text = dataService.Trabajador;
            lblProtocolName.Text = dataService.ProtocolName;
            lblSexo.Text = dataService.SexTypeId == 1 ? "MASCULINO" : "FEMENINO";
            lblEdad.Text = _age.ToString() + " Años.";
        ...
        private UltraTab CrearTab(ComponentList component)
        {
            ...
            if (component.i_ServiceComponentStatusId == (int)ServiceComponentStatus.Evaluado) ultraTab.Appearance.BackColor = Color.GreenYellow;
        ...
        private void GetAntecedentConsolidateForService(string personId)
        {
            ...
            ultraGrid2.DataSource = antecedent;
            GetValueResult(_objOperationResult);
        }
        ...
        private static void SetControlValidate(int controlId, Control ctrl, float? validateValue1, float? validateValue2, UltraValidator uv)
        {
            ...
            uv.ErrorAppearance.BorderColor = Color.GreenYellow;
        ...
        private void LoadDataBySelectedComponent_Async(string pstrComponentId)
        {
                ...
                if (_serviceComponentsInfo != null)
                {
                    ...
                    if (_serviceComponentsInfo.i_ServiceComponentStatusId == 3)
                    {
                        rbCulminado.Checked = true;
                    }
                    else if (_serviceComponentsInfo.i_ServiceComponentStatusId == 4)
                    {
                        rbPorReevaluar.Checked = true;
                    }
                    else if (_serviceComponentsInfo.i_ServiceComponentStatusId == 5)
                    {
                        rbNoRealizado.Checked = true;
                    }
                    else if (_serviceComponentsInfo.i_ServiceComponentStatusId == 6)
                    {
                        rbPorAprobacion.Checked = true;
                    }
                    else
                    {
                        rbCulminado.Checked = true;
        ...
        private void PopulateDataExam(string serviceComponentId)
        {
            ...
            }).ContinueWith(t =>
            {
                ...
                if (serviceComponentsInfo.i_ServiceComponentStatusId == 3)
                {
                    rbCulminado.Checked = true;
                }
                else if (serviceComponentsInfo.i_ServiceComponentStatusId == 4)
                {
                    rbPorReevaluar.Checked = true;
                }
                else if (serviceComponentsInfo.i_ServiceComponentStatusId == 5)
                {
                    rbNoRealizado.Checked = true;
                }
                else if (serviceComponentsInfo.i_ServiceComponentStatusId == 6)
                {
                    rbPorAprobacion.Checked = true;
                }
                else
        ...
        private void PaintGrdDiagnosticoPorExamenComponente()
        {
            foreach (var t in grdDiagnosticoPorExamenComponente.Rows)
            {
                ...
                {
                    case PreQualification.SinPreCalificar:
                        t.Appearance.BackColor = Color.GreenYellow;
                        t.Appearance.BackColor2 = Color.GreenYellow;
                        break;
                    case PreQualification.Aceptado:
        ...
        private void GrabarDiagnosticos()
        {
            ...
            if (rbCulminado.Checked == true)
            {
                serviceComponentDto.i_ServiceComponentStatusId = 3;
                _EstadoComponente = 3;
            }
            else if (rbPorReevaluar.Checked == true)
            {
                serviceComponentDto.i_ServiceComponentStatusId = 4;
                _EstadoComponente = 4;
            }
            else if (rbNoRealizado.Checked == true)
            {
                serviceComponentDto.i_ServiceComponentStatusId = 5;
                _EstadoComponente = 5;
            }
            else if (rbPorAprobacion.Checked == true)
            {
                serviceComponentDto.i_ServiceComponentStatusId = 6;
                _EstadoComponente = 6;
            }
        ...
        private bool validacionAuditado()
        {
            ...
            //    return true;
            //}
            //if (rbCulminado.Checked == true && _profesionId == 30)//evaluador
            //{
            //    MessageBox.Show("El examen ya fue AUDITADO, no puede guardar los cambios.", "CONFIRMACIÓN!", MessageBoxButtons.OK, MessageBoxIcon.Question);
            //    return true;
            //}
                ...
                if (uv.Validate(false, true).IsValid)
                {
                    ...
                    using (new LoadingClass.PleaseWait(this.Location, "Grabando..."))
                    {
                        ...
                        if (Result == DialogResult.Yes)
                        {
                            ...
                            //serviceComponentDto.i_ServiceComponentStatusId = int.Parse(cbEstadoComponente.SelectedValue.ToString());
                            if (rbCulminado.Checked == true)
                                serviceComponentDto.i_ServiceComponentStatusId = _EstadoComponente = 3;
                            else if (rbPorReevaluar.Checked == true)
                                serviceComponentDto.i_ServiceComponentStatusId = _EstadoComponente = 4;
                            else if (rbNoRealizado.Checked == true)
                                serviceComponentDto.i_ServiceComponentStatusId = _EstadoComponente = 5;
                            else if (rbPorAprobacion.Checked == true)
                                serviceComponentDto.i_ServiceComponentStatusId = _EstadoComponente = 6;
                            else
                                serviceComponentDto.i_ServiceComponentStatusId = _EstadoComponente = 3;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            var ServiceDate = ultraGrid1.Selected.Rows[0].Cells["d_ServiceDate"].Value.ToString();
        ...
        private void ProcessControlBySelectedTab_AMC(Infragistics.Win.UltraWinTabControl.UltraTabPageControl selectedTab)
        {
            ...
            var componentId = selectedTab.Tab.Key;
            var component = _tmpServiceComponentsForBuildMenuList.Find(p => p.v_ComponentId == componentId);
            //|| cbEstadoComponente.SelectedIndex == 1
            if (_EstadoComponente == (int)ServiceComponentStatus.Evaluado )
            {
                selectedTab.Tab.Appearance.BackColor = Color.GreenYellow;
            }
            else
            {
            ...
            else // todos los examenes están con el estado evaluado
            {
                ...
                else if (_tipo == (int)MasterService.Eso)
                {
                    if (cbAptitudEso.SelectedValue.ToString() == ((int)AptitudeStatus.SinAptitud).ToString())
                    {
                        ...
                        objserviceDto.i_ServiceStatusId = (int)ServiceStatus.Culminado;
                        objserviceDto.i_AptitudeStatusId = (int)AptitudeStatus.Evaluado;
        ...
        private void btnVerServicioAnterior_Click_1(object sender, EventArgs e)
        {
            //var datosP = _pacientBL.DevolverDatosPaciente(_serviceIdByWiewServiceHistory);
        ...
        {
            btnVerServicioAnterior.Enabled = (ultraGrid1.Selected.Rows.Count > 0);

            if (ultraGrid1.Selected.Rows.Count == 0)
                return;

            _serviceIdByWiewServiceHistory = ultraGrid1.Selected.Rows[0].Cells["v_ServiceId"].Value.ToString();
        }
        ...
        {
            //var lbl = sender as Button;lbl != null &&
            if ( btnMostrarOcultar.Text == "Ver Diagnósticos ...")
            {
                splitContainer2.SplitterDistance = splitContainer2.Height - 120;
                btnMostrarOcultar.Text = string.Format("{0}", "Ver menos");
                btnMostrarOcultar.ForeColor = Color.Blue;
            }
            else
            {
                //if (lbl == null) return;
                splitContainer2.SplitterDistance = splitContainer2.Height;
                btnMostrarOcultar.Text = "Ver Diagnósticos ...";
                btnMostrarOcultar.ForeColor = Color.Red;
            }
        }

        private void btnActualizarSignosVitales_Click(object sender, EventArgs e)
        {
            DatosTriaje(_serviceId);
        }
        ...
        {
            frmAntecedentes frm = new frmAntecedentes(_personId, txtAntPersonales.Text, txtAntFamiliares.Text);
            frm.ShowDialog();
