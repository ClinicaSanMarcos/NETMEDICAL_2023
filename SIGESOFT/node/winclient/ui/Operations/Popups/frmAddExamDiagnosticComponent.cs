...
namespace Sigesoft.Node.WinClient.UI.Operations.Popups
{
    public partial class frmAddExamDiagnosticComponent : Form
    {
        ...
        List<DxFrecuenteList> GetDataList = new List<DxFrecuenteList>();
        List<DxFrecuenteList> GetDataListTemp = new List<DxFrecuenteList>();

        private List<DiseasesList> GetDataListG = new List<DiseasesList>();
        private List<DiseasesList> GetDataListGTemp = new List<DiseasesList>();
        ...
        private void txtDiseasesFilter_KeyUp(object sender, KeyEventArgs e)
        {
            if (rbDescription.Checked == true)
            {
                txtDiseasesFilter.MaxLength = 500;


                if (txtDiseasesFilter.Text != string.Empty)
                {
                    GetDataListTemp = new List<DxFrecuenteList>(GetDataList.Where(p => p.v_DiseasesName.Contains(txtDiseasesFilter.Text.ToUpper())));

                    grdData.DataSource = GetDataListTemp;

                    if (GetDataListTemp != null)
                    {
                        lblRecordCount.Text = string.Format("Se encontraron {0} registros.", GetDataListTemp.Count());
                ...
                {
                    grdData.DataSource = GetDataList;

                    if (GetDataList != null)
                    {
                        lblRecordCount.Text = string.Format("Se encontraron {0} registros.", GetDataList.Count());
            ...
            {
                txtDiseasesFilter.MaxLength = 4;


                if (txtDiseasesFilter.Text != string.Empty)
                {
                    GetDataListTemp = new List<DxFrecuenteList>(GetDataList.Where(p => p.v_CIE10Id.Contains(txtDiseasesFilter.Text.ToUpper())));
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (rbCodeG.Checked == true)
            {
                if (!string.IsNullOrEmpty(txtDiseasesFilterG.Text)) Filters.Add("v_CIE10Id.Contains(\"" + txtDiseasesFilterG.Text.Trim() + "\")");
            }
            else
            {
                if (!string.IsNullOrEmpty(txtDiseasesFilterG.Text)) Filters.Add("v_Name.Contains(\"" + txtDiseasesFilterG.Text.Trim() + "\")");
                if (!string.IsNullOrEmpty(txtDiseasesFilterG.Text)) Filters.Add("v_CIE10Description1.Contains(\"" + txtDiseasesFilterG.Text.Trim() + "\")");
            }
        ...
        private void BindGridG()
        {
            var objData = GetDataG(0, null, "v_Name ASC, v_DiseasesId ASC", strFilterExpression);
            GetDataListG = objData;
            grdDataG.DataSource = objData;
            lblRecordCountG.Text = string.Format("Se encontraron {0} registros.", objData.Count());
        }

        private List<DiseasesList> GetDataG(int pintPageIndex, int? pintPageSize, string pstrSortExpression, string pstrFilterExpression)
        {
            OperationResult objOperationResult = new OperationResult();

            if (chkDiseasesOld.Checked == true)
            {
            ...
            {
                var _objData = _objMedicalExamFieldValuesBL.GetDiseasesPagedAndFilteredSoloDiseases(ref objOperationResult, pintPageIndex, pintPageSize, pstrSortExpression, pstrFilterExpression);
        ...
        private void txtDiseasesFilterG_KeyUp(object sender, KeyEventArgs e)
        {
            if (rbDescriptionG.Checked == true)
            {
                txtDiseasesFilterG.MaxLength = 500;


                if (txtDiseasesFilterG.Text != string.Empty)
                {
                    GetDataListGTemp = new List<DiseasesList>(GetDataListG.Where(p => p.v_Name.Contains(txtDiseasesFilterG.Text.ToUpper())));

                    grdDataG.DataSource = GetDataListGTemp;

                    if (GetDataListGTemp != null)
                    {
                        lblRecordCountG.Text = string.Format("Se encontraron {0} registros.", GetDataListGTemp.Count());
                ...
                {
                    grdDataG.DataSource = GetDataListG;

                    if (GetDataListG != null)
                    {
                        lblRecordCountG.Text = string.Format("Se encontraron {0} registros.", GetDataListG.Count());
            ...
            {
                txtDiseasesFilterG.MaxLength = 4;


                if (txtDiseasesFilterG.Text != string.Empty)
                {
                    GetDataListGTemp = new List<DiseasesList>(GetDataListG.Where(p => p.v_CIE10Id.Contains(txtDiseasesFilterG.Text.ToUpper())));
        ...
        private void btnUpdateandSelect_Click(object sender, EventArgs e)
        {
            ...
            if (ultraValidator2.Validate(true, false).IsValid)
            {
                if (grdDataG.Selected.Rows[0].Cells[0].Value != null)
                {
                    objDiseaseDto = _objMedicalExamFieldValuesBL.GetDiseases(ref  objOperationResult, grdDataG.Selected.Rows[0].Cells[0].Value.ToString());

                    objDiseaseDto.v_CIE10Id = grdDataG.Selected.Rows[0].Cells[1].Value.ToString();
                    ...
                    _DiseasesId = objDiseaseDto.v_DiseasesId;
                    _CIE10Id = objDiseaseDto.v_CIE10Id;
                    lblDiagnostico.Text = objDiseaseDto.v_Name + " / " + objDiseaseDto.v_CIE10Id;
                    _diagnosticId = objDiseaseDto.v_DiseasesId;
            ...
            var recomendationId = "N001-MR000000001";
        ...
        private void grdDataG_Click(object sender, EventArgs e)
        {
            if (grdDataG.Selected.Rows == null) return;
            if (grdDataG.Selected.Rows.Count == 0) return;

            btnUpdateandSelect.Enabled = true;
            if (grdDataG.Selected.Rows[0].Cells[0].Value != null)
            {
                txtDiseases.Text = grdDataG.Selected.Rows[0].Cells[2].Value.ToString();
                txtDiseases.Enabled = false;
            }
            else
            {
                txtDiseases.Enabled = true;
                txtDiseases.Text = grdDataG.Selected.Rows[0].Cells[2].Value.ToString();
