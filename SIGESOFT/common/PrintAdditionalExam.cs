    ...
    public class PrintAdditionalExam
    {
        public void GenerateAdditionalexam(string filePDF, organizationDto MedicalCenter, PacientList DatosPaciente, UsuarioGrabo usuarioGraba, string MotivoComentario, List<Categoria> DataSource, List<AdditionalExamCustom> ListAdditional, string EdadCompleto)
        {
            ...
            cells = new List<PdfPCell>()
            {
                ...
                new PdfPCell(new Phrase("CMP: ", fontTitle2)) {Colspan = 1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 20f,BorderColor= BaseColor.BLACK},
                new PdfPCell(new Phrase(CMP, fontTitle2)) {Colspan = 1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 20f,BorderColor= BaseColor.BLACK},
                new PdfPCell(new Phrase("FIRMA ", fontTitle2)) {Colspan = 1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_CENTER, MinimumHeight = 20f,BorderColor= BaseColor.BLACK},
            ...
            columnWidths = new float[] { 10f, 45f, 50f };
            table = HandlingItextSharp.GenerateTableFromCells(cells, columnWidths, null, fontTitleTable);
            document.Add(table);
            #endregion
