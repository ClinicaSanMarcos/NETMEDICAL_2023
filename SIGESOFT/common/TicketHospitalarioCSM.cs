...
namespace NetPdf
{
    public class TicketHospitalarioCSM
    {
        ...
        public static void CrearTicketConsumo(string filePDF,
            ...
            hospitalizacionhabitacionDto hospitHabit, MedicoTratanteAtenciones medico, ticketDto ticket, protocolDto protocolo)
        {
            ...
            else if (hospitHabit.i_HabitacionId == 17) n_habitac = "500";
            else if (hospitHabit.i_HabitacionId == 18) n_habitac = "401";
            else if (hospitHabit.i_HabitacionId == 19) n_habitac = "402";
            else if (hospitHabit.i_HabitacionId == 20) n_habitac = "403";
            else if (hospitHabit.i_HabitacionId == 21) n_habitac = "404";
            else if (hospitHabit.i_HabitacionId == 22) n_habitac = "405";
            else if (hospitHabit.i_HabitacionId == 23) n_habitac = "406";
            else if (hospitHabit.i_HabitacionId == 24) n_habitac = "407";
            else if (hospitHabit.i_HabitacionId == 25) n_habitac = "408";
            else if (hospitHabit.i_HabitacionId == 26) n_habitac = "501";
            else if (hospitHabit.i_HabitacionId == 27) n_habitac = "502";
            else if (hospitHabit.i_HabitacionId == 28) n_habitac = "503";
            else if (hospitHabit.i_HabitacionId == 29) n_habitac = "504";
            else if (hospitHabit.i_HabitacionId == 30) n_habitac = "505";
            else if (hospitHabit.i_HabitacionId == 31) n_habitac = "506";
            else if (hospitHabit.i_HabitacionId == 32) n_habitac = "507";
            else if (hospitHabit.i_HabitacionId == 33) n_habitac = "508";
            else if (hospitHabit.i_HabitacionId == 34) n_habitac = "601";
            else if (hospitHabit.i_HabitacionId == 35) n_habitac = "602";
            else if (hospitHabit.i_HabitacionId == 36) n_habitac = "603";
            else if (hospitHabit.i_HabitacionId == 37) n_habitac = "604";
            else if (hospitHabit.i_HabitacionId == 38) n_habitac = "605";
            else n_habitac = "- - -";
            ...
            cells = new List<PdfPCell>()
            {
                    ...
                    new PdfPCell(new Phrase(": " + protocolo.v_Name, fontColumnValue)) { Colspan=2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda, UseVariableBorders=true, BorderColorLeft=BaseColor.WHITE,  BorderColorRight=BaseColor.WHITE,  BorderColorBottom=BaseColor.WHITE, BorderColorTop=BaseColor.BLACK},
                    new PdfPCell(new Phrase("CÓDIGO INTERNO", fontColumnValueBold)) {Colspan=1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda, UseVariableBorders=true, BorderColorLeft=BaseColor.WHITE,  BorderColorRight=BaseColor.WHITE,  BorderColorBottom=BaseColor.WHITE, BorderColorTop=BaseColor.BLACK},
                    new PdfPCell(new Phrase(": " + hospitHabit.v_HopitalizacionId, fontColumnValue)) {Colspan=2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda, UseVariableBorders=true, BorderColorLeft=BaseColor.WHITE,  BorderColorRight=BaseColor.WHITE,  BorderColorBottom=BaseColor.WHITE, BorderColorTop=BaseColor.BLACK},
                    ...
                    new PdfPCell(new Phrase("HISTORIA CLINICA", fontColumnValueBold)) {Colspan=1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda, UseVariableBorders=true, BorderColorLeft=BaseColor.WHITE,  BorderColorRight=BaseColor.WHITE,  BorderColorBottom=BaseColor.WHITE, BorderColorTop=BaseColor.WHITE},
                    new PdfPCell(new Phrase(": " + datosPac.N_Informe, fontColumnValueBold)) {Colspan=5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda, UseVariableBorders=true, BorderColorLeft=BaseColor.WHITE,  BorderColorRight=BaseColor.WHITE,  BorderColorBottom=BaseColor.WHITE, BorderColorTop=BaseColor.WHITE},
                   

                    new PdfPCell(new Phrase("DOC IDENT", fontColumnValueBold)) { HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda, UseVariableBorders=true, BorderColorLeft=BaseColor.WHITE,  BorderColorRight=BaseColor.WHITE,  BorderColorBottom=BaseColor.WHITE, BorderColorTop=BaseColor.WHITE},
                    ...
                    new PdfPCell(new Phrase(": " + datosPac.v_Employer, fontColumnValue)) {Colspan = 2 , HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda, UseVariableBorders=true, BorderColorLeft=BaseColor.WHITE,  BorderColorRight=BaseColor.WHITE,  BorderColorBottom=BaseColor.WHITE, BorderColorTop=BaseColor.WHITE},
            ...
            if (detalleTicket != null)
            {
                ...
                {
                    cell = new PdfPCell(new Phrase(item.v_Descripcion, fontColumnValue)) { HorizontalAlignment = PdfPCell.ALIGN_LEFT, UseVariableBorders = true, BorderColorLeft = BaseColor.BLACK, BorderColorRight = BaseColor.BLACK, BorderColorBottom = BaseColor.BLACK, BorderColorTop = BaseColor.BLACK, MinimumHeight = 15f };
                    cells.Add(cell);
                    int cantidad = (int)item.d_Cantidad;
                    cell = new PdfPCell(new Phrase(cantidad.ToString(), fontColumnValue)) { HorizontalAlignment = PdfPCell.ALIGN_CENTER, UseVariableBorders = true, BorderColorLeft = BaseColor.BLACK, BorderColorRight = BaseColor.BLACK, BorderColorBottom = BaseColor.BLACK, BorderColorTop = BaseColor.BLACK, MinimumHeight = 15f };
                    cells.Add(cell);
