...
namespace NetPdf
{
    public class pdfPage2 : PdfPageEventHelper
    {
        ...
        public override void OnEndPage(PdfWriter writer, Document doc)
        {
            var rutaImg = Sigesoft.Common.Utils.GetApplicationConfigValue("imgFooter3");
            ...
            {
                var imageCell = new PdfPCell(HandlingItextSharp.GetImage(rutaImg, null, null, 810, 42)) { Border = PdfPCell.NO_BORDER };
                footerTbl.AddCell(imageCell);
                footerTbl.WriteSelectedRows(0, -1, doc.LeftMargin, (doc.BottomMargin + 0), writer.DirectContent);
            }
