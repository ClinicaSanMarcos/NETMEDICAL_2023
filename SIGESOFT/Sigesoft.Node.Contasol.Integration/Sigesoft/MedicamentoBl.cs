...
namespace Sigesoft.Node.Contasol.Integration
{
    public class MedicamentoBl
    {
        public List<MedicamentoDto> GetListMedicamentos(ref OperationResult pobjOperationResult, string nombre,
            string accionFarmaco, bool medicinaNoExistente)
        {
            try
            {
                ...
                string validarFarmaco = "";
                //if (medicinaNoExistente == false)
                //{
                //    validarFarmaco = "pa.d_StockActual > 0 and ";
                //}
                ...
                using (var cnx = ConnectionHelper.GetConnection)
                {
                    ...
                    var query =
                        ...
                        "ISNULL(p.v_Descripcion2,'') as AccionFarmaco, ISNULL(p.v_PrincipioActivo,'') as PrincipioActivo, " +
                        ...
                        "where (" + nombre + " is null or lower(p.\"v_Descripcion\") like " + nombre + ") and p.i_EsActivo =1 and " + validarFarmaco +
                        "(" + accionFarmaco + " is null or lower(p.\"v_Descripcion2\") like " + accionFarmaco + ") " +
                        "and pa.i_IdAlmacen = 1 and p.\"i_Eliminado\" = 0 and pa.v_Periodo=  " + DateTime.Now.ToString().Split('/', ' ')[2] + " and pa.i_Eliminado = 0 order by 'Nombre';";
                ...
                using (var dbContext = ConnectionHelper.ContasolContext)
                {
                    ...
                    if (entidad == null)
                    {
                        ...
                        var productoToInsert = new productoDto
                        {
                            ...
                            v_Descripcion2 = pobjDto.AccionFarmaco,
                    ...
                    else
                    {
                        ...
                        prodOriginal.v_Descripcion2 = pobjDto.AccionFarmaco;
