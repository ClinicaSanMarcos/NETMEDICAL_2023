    ...
    public class MedicamentoDao
    {
        ...
        public static string CodigoNuevo()
        {
            try
            {
                ...
                {
                    if (cnx.State != ConnectionState.Open) cnx.Open();
                    const string query = " select TOP 1 v_CodInterno as 'Nombre' from producto where i_Eliminado  = 0 and v_CodInterno like 'FNE-%' ORDER BY v_CodInterno DESC ";
                    ...
                    string codigoNuevo = string.Format("FNE-{0}", correlativo.ToString("000000000"));
